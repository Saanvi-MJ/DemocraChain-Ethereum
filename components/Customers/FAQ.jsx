    ...
    <section className="faq pb-120 pt-120 position-relative z-0">
      <div className="animation position-absolute top-0 left-0 w-100 h-100 z-n1">
        <img
          ...
          alt="vector"
          className="position-absolute pt-6 pt-xl-15 previewShapeRevX  d-none d-lg-flex"
        />
        <img
          src="assets/images/star30.png"
          alt="vector"
          className="position-absolute push_animat end-0 top-0  pt-120 mt-4 me-xl-20 pe-20 d-none d-xxl-flex"
        />
        <img
